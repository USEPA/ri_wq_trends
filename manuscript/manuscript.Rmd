...
During the selected sampling period of 1990 to 2016 average lake temperature was `r ww_param_ranges%>%filter(param == "temp")%>%pull(mean)`, average total nitrogen was `r ww_param_ranges%>%filter(param == "total_n")%>%pull(mean)`, average total phosphorus was `r ww_param_ranges%>%filter(param == "total_p")%>%pull(mean)`, and average chlorophyll was `r ww_param_ranges%>%filter(param == "chla")%>%pull(mean)` (`r tab_num("ww_params", display = "cite", caption = "Summary statistics for URI Watershed Watch data from 1990 to 2016.")`) 
...
![`r fig_num(name = "temp_ri", caption = "Yearly trend over 20+ years of lake temperature in Rhode Island lakes and ponds.")`](../figures/ww_temp_trends.jpg)

![`r fig_num(name = "tn_ri", caption = "Yearly trend over 20+ years of Total Nitrogen (average z-score) in Rhode Island lakes and ponds.")`](../figures/ww_tn_trends.jpg)

![`r fig_num(name = "tp_ri", caption = "Yearly trend over 20+ years of Total Phosphorus (average z-score) in Rhode Island lakes and ponds.")`](../figures/ww_tp_trends.jpg)

![`r fig_num(name = "chla_ri", caption = "Yearly trend over 20+ years of Chlorphyll *a* (average z-score) in Rhode Island lakes and ponds.")`](../figures/ww_chla_trends.jpg)

## Regional trends in water quality

![`r fig_num(name = "tn_lagos", caption = "Yearly trend over 20+ years of Total Nitrogen (average z-score) in the LAGOSNE states.")`](../figures/lagos_tn_trends.jpg)

![`r fig_num(name = "tp_lagos", caption = "Yearly trend over 20+ years of Total Phosphorus (average z-score) in the LAGOSNE states.")`](../figures/lagos_tp_trends.jpg)

![`r fig_num(name = "chla_lagos", caption = "Yearly trend over 20+ years of Chlorophyll *a* (average z-score) in the LAGOSNE states.")`](../figures/lagos_chla_trends.jpg)

...
Furthermore, since we are interested in water quality trends over time, we wanted to explore how each site was responding.  Thus, our z-scores were calculated over the reference period, 1993-2016, for each site.  In other words the long-term mean and standard deviation were calculated on a site-by-site basis. 

### Summarizing z-scores

Add stuff here. Include an example figure with columns as years, rows as lakes showing how to calc z and summarize.

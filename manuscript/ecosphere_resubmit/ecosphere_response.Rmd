...
- **Response:** We applied the same within and across year filters to the LAGOSNE and these results have changed as well.  Given that and our method for interpreting the trends leads to the following:  LAGOSNE is showing weak statistical support for a negative change in nitrogen, with more below average years recently.  The slope is less than the 3.5 we identified, albeit close.  Thus we conclude a weak decrease in TN at the scale of the Region.  This is indicated in the manuscript.

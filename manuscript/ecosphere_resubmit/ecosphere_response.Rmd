...
- **Response:** Again, with the changes to the filtering the trend lines have slightly changed.  We concur with Reviewer 1's take that TP is showing a slight increasing trend with some statistical support for a trend, athough the slope is not greater than the threshold we identified and greater frequency of above average years in recent years.  We have indicated as such in the text.
...
- **Response:** Small changes due to filtering and new criteria for assessing the trend are also seen here.  There is statistical support for a trend, that trend is positive and the magnitude of the slope suggests the possibility of ecological significant change in TP over a century.  This has been added to the manuscript.
...
- **Response:** Agreed.  Language softened and title changed to hopefully steer readers away from causation.  No changes made.
...
- **Response:** We changed the wording on this to reflect a focus on the need to know about long term trends.  Also we added three citation that specifically address that sharing results back with volunteers meets their expectations and can motivate continued involvement.
...
- **Response:** This section was re-written.  We mention nutrient reductions as one possible hypothesis that long-term trends like those seen in RI can inform.
...
- **Response:** We added a summary table that summarizes average lake area, maximum depth, and average percent forest, ag, and developed for the LAGOSNE and URIWW.  Some additional text is in the methods as well as in the results.  Thanks for the suggestion.  There are a few differences and are a useful addition to the paper. 

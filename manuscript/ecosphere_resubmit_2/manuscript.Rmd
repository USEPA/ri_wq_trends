...
Add Paragraph about RI lakes: Context about human pressures on RI lakes + one sentence about adequate data being available
...
Lastly, data and code for the entire analysis is available from <https://github.com/USEPA/ri_wq_trends/> and is archived at <https://doi.org/10.5281/zenodo.4050275 > [@zenodo_citation].  Values included in each of the figures have also been separately saved as a comma-separated values file, `yearly_average_anomaly.csv`, and may be retrieved via <https://github.com/USEPA/ri_wq_trends/raw/master/data/yearly_average_anomaly.csv>.
